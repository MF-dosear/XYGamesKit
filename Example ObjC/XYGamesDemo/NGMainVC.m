...
#import "NGMainVC.h"
#import <XYGamesKit/XYGamesKit-umbrella.h>
...
- (void)viewDidLoad {
    ...
    [XYGamesKit sdkInitWithApp_id:@"1000001" app_key:@"48f2bd0d7ab066687f0ab2b85241ae34" link:@"cwdzz" appld_id:@"1670290308" jy_app_key:@"17beb89b4554b40dcc0e0f8fa1ec2152" result:^(BOOL flag) {
        
        NSLog(@"初始化：flag = %d", flag);
    }];
    
    [XYGamesKit sdkLogoutBackWithResult:^(BOOL flag) {
